...
<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            {!! Form::open(['route' => ['workflow.admin.workflows.places.destroy', $workflow, $place], 'method' => 'DELETE']) !!}
    ...
    <div class="box-body">
        ...
        <div class="box">
            ...
            <div class="box-body" id="notifications">
                @foreach($place->notifications as $notification)
                    <?php
